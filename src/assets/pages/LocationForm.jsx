					...
					<div key={index} className="hours-row">
						<input
							...
							onChange={(e) =>
								setHours((prev) =>
									prev.map((h, i) =>
										i === index ? { ...h, days: e.target.value } : h
									)
								)
							}
							required
						...
						<input
							...
							onChange={(e) =>
								setHours((prev) =>
									prev.map((h, i) =>
										i === index ? { ...h, from: e.target.value } : h
									)
								)
							}
							required
				...
				{menu.drinks.map((item, index) => (
					<div key={index} className="menu-item">
						<input
							...
							value={item.name}
							onChange={(e) =>
								handleMenuChange('drinks', index, 'name', e.target.value)
							}
						/>
						<input
							type="number"
							...
							value={item.price}
							onChange={(e) =>
								handleMenuChange('drinks', index, 'price', e.target.value)
							}
						/>
				...
				{menu.food.map((item, index) => (
					<div key={index} className="menu-item">
						<input
							...
							value={item.name}
							onChange={(e) =>
								handleMenuChange('food', index, 'name', e.target.value)
							}
						/>
						<input
							type="number"
							...
							value={item.price}
							onChange={(e) =>
								handleMenuChange('food', index, 'price', e.target.value)
							}
						/>
