	...
	return (
		<form onSubmit={handleSubmit}>
			...
			<div className='form-group'>
				...
				{hours.map((hour, index) => (
					<div
						...
						<input
							...
							className='form-input'
							value={hour.to}
							onChange={(e) => setHours((prev) => prev.map((h, i) => (i === index ? { ...h, to: e.target.value } : h)))}
							required
						/>
						<button
							type='button'
				...
				<button
					type='button'
					onClick={() => setHours((prev) => [...prev, { days: '', from: '', to: '' }])}>
					Add Hours
				</button>
			</div>
				...
				{menu.drinks.map((item, index) => (
					<div
						...
						<input
							...
							className='form-input'
							value={item.name}
							onChange={(e) => handleMenuChange('drinks', index, 'name', e.target.value)}
						/>
						<input
							type='number'
							placeholder='Price'
							className='form-input'
							value={item.price}
							onChange={(e) => handleMenuChange('drinks', index, 'price', e.target.value)}
						/>
						<button
							type='button'
				...
				{menu.food.map((item, index) => (
					<div
						...
						<input
							...
							className='form-input'
							value={item.name}
							onChange={(e) => handleMenuChange('food', index, 'name', e.target.value)}
						/>
						<input
							type='number'
							placeholder='Price'
							className='form-input'
							value={item.price}
							onChange={(e) => handleMenuChange('food', index, 'price', e.target.value)}
						/>
						<button
							type='button'
							onClick={() => removeMenuItem('food', index)}>
							Remove
						</button>
					</div>
				))}
